...
class AdoptionTest {
    ...
    void testToString() {
        ...
        assertTrue(adoptionToString.contains("animal=Animal(id=A001, name=Lola, color=marrón, size=mediano, race=mestizo, description=Muy cariñosa, birth_date=02-02-2020, entryDate=17-10-2024, sex=Hembra, age=5, sterile=true, disability=false, image=null)"));
