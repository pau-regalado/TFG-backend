...
public class DatabaseTest {
    ...
    private void seedDataBaseJava() {
        ...
        Animal[] animals = {
                ...
                Animal.builder().id("134").name("Tobias").color("gris y blanco").size("mediano").race("terrier mestizo").description("Muy carinosa").birth_date("02-04-2020").entryDate("10-10-2024").sex("Macho").age(2).sterile(true).disability(false).imageUrl(this.imageService.loadImageBase64("Tobias", "jpg")).build(),
                ...
                Animal.builder().id("137").name("Pipa").color("blanco").size("mediano").race("carlino").description("Muy carinosa").birth_date("22-03-2015").entryDate("10-09-2024").sex("Hembra").age(10).sterile(true).disability(true).imageUrl(this.imageService.loadImageBase64("Pipa", "webp")).build(),
                ...
                Animal.builder().id("140").name("Susan").color("beige y negro").size("mediano").race("mestizo").description("Muy carinosa").birth_date("14-07-2014").entryDate("27-03-2025").sex("Macho").age(11).sterile(true).disability(false).imageUrl(this.imageService.loadImageBase64("Susan", "webp")).build(),
                ...
                Animal.builder().id("142").name("Chispa").color("blanco y beige").size("mediano").race("mestizo").description("Muy carinosa").birth_date("17-02-2020").entryDate("17-10-2024").sex("Hembra").age(2).sterile(true).disability(false).imageUrl(this.imageService.loadImageBase64("Chispa", "jpg")).build(),
                ...
                Animal.builder().id("145").name("Paco").color("blanco").size("mediano").race("mastin").description("Muy carinosa").birth_date("22-03-2015").entryDate("11-10-2024").sex("Macho").age(10).sterile(true).disability(true).imageUrl(this.imageService.loadImageBase64("Paco", "jpg")).build(),
                Animal.builder().id("146").name("Cristal").color("beige y blanco").size("mediano").race("mestizo").description("Muy carinosa").birth_date("05-07-2018").entryDate("22-09-2024").sex("Hembra").age(7).sterile(true).disability(false).imageUrl(this.imageService.loadImageBase64("Cristal", "jpeg")).build(),
                Animal.builder().id("147").name("Marcus").color("beige").size("mediano").race("mestizo").description("Muy carinosa").birth_date("22-03-2020").entryDate("18-10-2024").sex("Macho").age(5).sterile(true).disability(false).imageUrl(this.imageService.loadImageBase64("Marcus", "jpg")).build(),
                Animal.builder().id("148").name("Roco").color("beige y negro").size("grande").race("mestizo").description("Muy carinosa").birth_date("18-07-2014").entryDate("27-02-2025").sex("Macho").age(11).sterile(true).disability(false).imageUrl(this.imageService.loadImageBase64("Roco", "jpg")).build(),
                Animal.builder().id("146").name("Melo").color("beige y negro").size("grande").race("mestizo").description("Muy carinosa").birth_date("22-12-2018").entryDate("02-09-2024").sex("Hembra").age(7).sterile(true).disability(true).imageUrl(this.imageService.loadImageBase64("Melo", "webp")).build(),
                Animal.builder().id("147").name("Truco").color("beige y blanco").size("mediano").race("mestizo").description("Muy carinosa").birth_date("22-05-2020").entryDate("20-10-2024").sex("Macho").age(5).sterile(true).disability(false).imageUrl(this.imageService.loadImageBase64("Truco", "jpg")).build(),
                Animal.builder().id("148").name("Rayo").color("beige y blanco").size("grande").race("mestizo").description("Muy carinosa").birth_date("19-07-2014").entryDate("27-05-2025").sex("Macho").age(11).sterile(true).disability(false).imageUrl(this.imageService.loadImageBase64("Rayo", "png")).build()
        };
