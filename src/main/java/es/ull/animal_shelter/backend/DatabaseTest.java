...
public class DatabaseTest {
    ...
    private void seedDataBaseJava() {
        ...
        AnimalShelter[] animalShelters = {
                ...
                AnimalShelter.builder().name("Rescue2").location("Santa Cruz").username("rescue2").password("admin").numberPhone(612345678).animalWL(List.of(animals[4], animals[5],animals[6],animals[7])).imageUrl(this.imageService.loadImageBase64("Rescue2", "jpg")).build(),
                AnimalShelter.builder().name("Rescue3").location("La Orotava").username("rescue3").password("admin").numberPhone(612345678).animalWL(List.of(animals[8], animals[9],animals[10],animals[11])).imageUrl(this.imageService.loadImageBase64("Rescue3", "jpg")).build(),
                AnimalShelter.builder().name("Rescue4").location("El Sauzal").username("rescue4").password("admin").numberPhone(612345678).animalWL(List.of(animals[11], animals[12],animals[13],animals[14])).imageUrl(this.imageService.loadImageBase64("Rescue4", "jpg")).build(),
                AnimalShelter.builder().name("Rescue5").location("Los Cristianos").username("rescue5").password("admin").numberPhone(612345678).animalWL(List.of(animals[15], animals[16],animals[17],animals[18], animals[19])).imageUrl(this.imageService.loadImageBase64("Rescue5", "jpg")).build()
        };
