...
public class DatabaseTest {
    ...
    public enum Race {
        ...
        DOGO("dogo"),
        PODENCO("podenco"),
        TERRIER_MIXED("terrier mestizo"),
        SPANISH_BLUE("spanien azul"),
        MASTIN("mastin"),
        CARLINO("carlino");
        private final String v;
        Race(String v) { this.v = v; }
        @Override public String toString() { return v; }
    }
    public enum Color {
        BROWN("marrón"), WHITE("blanco"), BLACK("negro"),
        BEIGE("beige"), GRAY_WHITE("gris y blanco"),
        BROWN_WHITE("marrón y blanco"),
        BEIGE_BLACK("beige y negro"),
        BEIGE_WHITE("beige y blanco"),
        WHITE_BLACK("blanco y negro"),
        WHITE_BEIGE("blanco y beige");
        private final String v;
        Color(String v) { this.v = v; }
        @Override public String toString() { return v; }
    }
    ...
    private void seedDataBaseJava() {
        ...
        Animal[] animals = {
                Animal.builder().id("128").name("Brenda")
                        .color(Color.BROWN_WHITE.toString()).size(Size.MEDIUM.toString())
                        .race(Race.BULL_TERRIER.toString())
                        ...
                        .sex(Sex.FEMALE.toString()).age(5).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Brenda", "jpg")).build(),

                Animal.builder().id("129").name("Dakota")
                        .color(Color.BEIGE.toString()).size(Size.SMALL.toString())
                        .race(Race.MIXED.toString())
                        ...
                        .sex(Sex.FEMALE.toString()).age(3).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Dakota", "jpeg")).build(),

                Animal.builder().id("130").name("Dodo")
                        .color(Color.BROWN.toString()).size(Size.LARGE.toString())
                        .race(Race.DOGO.toString())
                        .description("Con mucha energía y fuerza, necesita largos paseos diarios")
                        .birth_date("02-02-2023").entryDate("02-02-2025")
                        .sex(Sex.MALE.toString()).age(2).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Dodo", "jpeg")).build(),

                Animal.builder().id("131").name("Freddy")
                        .color(Color.WHITE.toString()).size(Size.LARGE.toString())
                        .race(Race.MIXED.toString())
                        .description("Noble y protector, disfruta de la tranquilidad del hogar")
                        .birth_date("23-04-2021").entryDate("28-12-2024")
                        .sex(Sex.MALE.toString()).age(4).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Freddy", "jpg")).build(),
                ...
                Animal.builder().id("132").name("Kalo")
                        ...
                        .sex(Sex.MALE.toString()).age(2).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Kalo", "webp")).build(),

                Animal.builder().id("133").name("Sheila")
                        .color(Color.BEIGE.toString()).size(Size.MEDIUM.toString())
                        .race(Race.MIXED.toString())
                        .description("Activa y sociable, se adapta fácilmente a pesar de su discapacidad")
                        .birth_date("24-08-2023").entryDate("18-01-2025")
                        .sex(Sex.FEMALE.toString()).age(2).sterile(true).disability(true)
                        .imageUrl(this.imageService.loadImageBase64("Sheila", "webp")).build(),

                Animal.builder().id("134").name("Tobias")
                        .color(Color.GRAY_WHITE.toString()).size(Size.MEDIUM.toString())
                        .race(Race.TERRIER_MIXED.toString())
                        .description("Cariñoso, algo tímido al principio, pero muy apegado cuando confía")
                        .birth_date("02-04-2020").entryDate("10-10-2024")
                        .sex(Sex.MALE.toString()).age(2).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Tobias", "jpg")).build(),

                Animal.builder().id("135").name("Nala")
                        .color(Color.BROWN_WHITE.toString()).size(Size.MEDIUM.toString())
                        .race(Race.PODENCO.toString())
                        ...
                        .sex(Sex.FEMALE.toString()).age(6).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Nala", "jpeg")).build(),

                Animal.builder().id("136").name("Max")
                        .color(Color.BLACK.toString()).size(Size.MEDIUM.toString())
                        .race(Race.SPANISH_BLUE.toString())
                        .description("Activo y alegre, siempre busca juegos y estímulos")
                        .birth_date("08-09-2021").entryDate("25-12-2024")
                        .sex(Sex.MALE.toString()).age(4).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Max", "jpg")).build(),

                Animal.builder().id("137").name("Pipa")
                        .color(Color.WHITE.toString()).size(Size.MEDIUM.toString())
                        .race(Race.CARLINO.toString())
                        .description("Tierna y calmada, necesita cuidados especiales y mucho cariño")
                        .birth_date("22-03-2015").entryDate("10-09-2024")
                        .sex(Sex.FEMALE.toString()).age(10).sterile(true).disability(true)
                        .imageUrl(this.imageService.loadImageBase64("Pipa", "webp")).build(),

                Animal.builder().id("138").name("Rocky")
                        .color(Color.BROWN_BLACK.toString()).size(Size.MEDIUM.toString())
                        .race(Race.MIXED.toString())
                        ...
                        .sex(Sex.MALE.toString()).age(7).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Rocky", "jpg")).build(),

                Animal.builder().id("139").name("Kai")
                        .color(Color.WHITE_BLACK.toString()).size(Size.LARGE.toString())
                        .race(Race.MIXED.toString())
                        ...
                        .sex(Sex.MALE.toString()).age(5).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Kai", "webp")).build(),

                Animal.builder().id("140").name("Susan")
                        .color(Color.BEIGE_BLACK.toString()).size(Size.MEDIUM.toString())
                        .race(Race.MIXED.toString())
                        .description("Tranquila y fiel, disfruta de paseos cortos y lugares cálidos")
                        .birth_date("14-07-2014").entryDate("27-03-2025")
                        .sex(Sex.MALE.toString()).age(11).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Susan", "webp")).build(),
                ...
                Animal.builder().id("141").name("Coffe")
                        ...
                        .birth_date("24-08-2023").entryDate("18-01-2025")
                        .sex(Sex.FEMALE.toString()).age(2).sterile(true).disability(true)
                        .imageUrl(this.imageService.loadImageBase64("Coffe", "jpg")).build(),

                Animal.builder().id("142").name("Chispa")
                        .color(Color.WHITE_BEIGE.toString()).size(Size.MEDIUM.toString())
                        .race(Race.MIXED.toString())
                        .description("Vivaz y juguetona, perfecta para hogares con niños")
                        .birth_date("17-02-2020").entryDate("17-10-2024")
                        .sex(Sex.FEMALE.toString()).age(2).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Chispa", "jpg")).build(),

                Animal.builder().id("143").name("Clara")
                        .color(Color.BROWN.toString()).size(Size.MEDIUM.toString())
                        .race(Race.MIXED.toString())
                        .description("Tranquila, leal y paciente, ideal para hogares serenos")
                        .birth_date("15-06-2019").entryDate("20-11-2024")
                        .sex(Sex.FEMALE.toString()).age(6).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Clara", "jpg")).build(),
                ...
                Animal.builder().id("144").name("Luna")
                        ...
                        .birth_date("08-09-2021").entryDate("25-12-2024")
                        .sex(Sex.FEMALE.toString()).age(4).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Luna", "jpg")).build(),

                Animal.builder().id("145").name("Paco")
                        .color(Color.WHITE.toString()).size(Size.MEDIUM.toString())
                        .race(Race.MASTIN.toString())
                        .description("Cariñoso y sereno, necesita un hogar donde lo cuiden con dedicación")
                        .birth_date("22-03-2015").entryDate("11-10-2024")
                        .sex(Sex.MALE.toString()).age(10).sterile(true).disability(true)
                        .imageUrl(this.imageService.loadImageBase64("Paco", "jpg")).build(),

                Animal.builder().id("146").name("Cristal")
                        .color(Color.BEIGE_WHITE.toString()).size(Size.MEDIUM.toString())
                        .race(Race.MIXED.toString())
                        .description("Obediente y dulce, disfruta de la compañía humana y las rutinas")
                        .birth_date("05-07-2018").entryDate("22-09-2024")
                        .sex(Sex.FEMALE.toString()).age(7).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Cristal", "jpeg")).build(),

                Animal.builder().id("147").name("Marcus")
                        .color(Color.BEIGE.toString()).size(Size.MEDIUM.toString())
                        .race(Race.MIXED.toString())
                        .description("Simpático y atento, le encanta aprender nuevos trucos")
                        .birth_date("22-03-2020").entryDate("18-10-2024")
                        .sex(Sex.MALE.toString()).age(5).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Marcus", "jpg")).build(),

                Animal.builder().id("148").name("Roco")
                        .color(Color.BEIGE_BLACK.toString()).size(Size.LARGE.toString())
                        .race(Race.MIXED.toString())
                        .description("Sabio y calmado, busca una familia que le ofrezca un retiro digno")
                        .birth_date("18-07-2014").entryDate("27-02-2025")
                        .sex(Sex.MALE.toString()).age(11).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Roco", "jpg")).build(),
                ...
                Animal.builder().id("149").name("Melo")
                        ...
                        .sex(Sex.FEMALE.toString()).age(7).sterile(true).disability(true)
                        .imageUrl(this.imageService.loadImageBase64("Melo", "webp")).build(),
                ...
                Animal.builder().id("150").name("Truco")
                        ...
                        .sex(Sex.MALE.toString()).age(5).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Truco", "jpg")).build(),

                Animal.builder().id("151").name("Rayo")
                        .color(Color.BEIGE_WHITE.toString()).size(Size.LARGE.toString())
                        .race(Race.MIXED.toString())
                        .description("Amigable y de ritmo pausado, un compañero tranquilo y agradecido")
                        .birth_date("19-07-2014").entryDate("27-05-2025")
                        .sex(Sex.MALE.toString()).age(11).sterile(true).disability(false)
                        .imageUrl(this.imageService.loadImageBase64("Rayo", "png")).build()
        };
        this.animalRepository.saveAll(List.of(animals));
        LogManager.getLogger(this.getClass()).warn("        ------- animals");

        Client[] clientsLogin = {
                Client.builder().name("Nico").lastName("Perez").username("Nico20")
                        .email("Nico20@gmail.com").password(ADMIN_PASSWORD)
                        .animalWL(List.of(animals[0])).build(),
                Client.builder().name("Pablo").lastName("Reyes").username("PabloReyes30")
                        .email("PabloReyes30@gmail.com").password(ADMIN_PASSWORD).build(),
                Client.builder().name("Paula").lastName("Regalado").username("PauRegalado01")
                        .email("PauRegalado01@gmail.com").password(ADMIN_PASSWORD).build(),
                Client.builder().name("Camila").lastName("Tejero").username("Cami87")
                        .email("Cami87@gmail.com").password(ADMIN_PASSWORD).build(),
                Client.builder().name("Nerea").lastName("Campos").username("NereaCampos99")
                        .email("NereaCampos99@gmail.com").password(ADMIN_PASSWORD).build()
        };
        ...
        AnimalShelter[] animalShelters = {
                AnimalShelter.builder().name("Rescue1")
                        ...
                        .username("rescue1").password(ADMIN_PASSWORD)
                        .numberPhone(612345678)
                        .animalWL(List.of(animals[0], animals[1], animals[2], animals[3], animals[20]))
                        .imageUrl(this.imageService.loadImageBase64("Rescue1", "png")).build(),
                AnimalShelter.builder().name("Rescue2")
                        ...
                        .username("rescue2").password(ADMIN_PASSWORD)
                        .numberPhone(612345678)
                        .animalWL(List.of(animals[4], animals[5], animals[6], animals[7]))
                        .imageUrl(this.imageService.loadImageBase64("Rescue2", "jpg")).build(),
                AnimalShelter.builder().name("Rescue3")
                        ...
                        .username("rescue3").password(ADMIN_PASSWORD)
                        .numberPhone(612345678)
                        .animalWL(List.of(animals[8], animals[9], animals[10], animals[11]))
                        .imageUrl(this.imageService.loadImageBase64("Rescue3", "jpg")).build(),
                AnimalShelter.builder().name("Rescue4")
                        ...
                        .username("rescue4").password(ADMIN_PASSWORD)
                        .numberPhone(612345678)
                        .animalWL(List.of(animals[11], animals[12], animals[13], animals[14]))
                        .imageUrl(this.imageService.loadImageBase64("Rescue4", "jpg")).build(),
                AnimalShelter.builder().name("Rescue5")
                        ...
                        .username("rescue5").password(ADMIN_PASSWORD)
                        .numberPhone(612345678)
                        .animalWL(List.of(animals[15], animals[16], animals[17], animals[18], animals[19]))
                        .imageUrl(this.imageService.loadImageBase64("Rescue5", "jpg")).build()
        };
